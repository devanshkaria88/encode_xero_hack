...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-card shadow-lg transition ease-in-out-quiet data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-normal data-[state=open]:duration-slow",
  {
    variants: {
      side: {
